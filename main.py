...
class Enemy:
    walkRight = [pygame.image.load('enemypixel.bmp')]
    walkLeft = [pygame.image.load('enemypixel.bmp')]
    ...
    def __init__(self, x, y, width, height, end):
        ...
        self.path = [x, end]
        self.vel = 4
        self.image = pygame.image.load('enemypixel.bmp').convert_alpha()
...
if __name__ == '__main__':
    ...
    enemy_img = pygame.image.load('enemypixel.bmp').convert_alpha()
